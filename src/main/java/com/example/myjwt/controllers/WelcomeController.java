...
public class WelcomeController {
	...
	private void createDefaultReferredCategories() {
		...
		String[] referralCategories = { "Referred", "Interview scheduled", "Screen Reject",
				"Interview Rejected", "Interview Selected", "Client Interview scheduled", "Client Screen Reject", "Client Interview Rejected" , "Client Interview Selected","Offer in progress",
				"Offered","Joined","Offer Declined","Rejected: No approval"};
