...
const UpdateStatus = (props) => {
  ...
  useEffect(() => {
    ProfileService.getReferralInfo(referralId).then(
      (response) => {
  ...
  const handleSubmit = async (event) => {
    ...
    let userToken = await ProfileService.getStatusFromId(statusId);
    var user = userToken.groupValue

    console.log(userToken);


    ProfileService.updateReferralStatus(user,referralId).then((response) => {
